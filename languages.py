dictionary_ = {'info_name':   ["Software creato da Tommaso Bocchietti",
               ...
               'printimg_setting_filling': ["Modalità riempimento (Beta)",
                                            "",
                                            ""],
               ...
               'printtext_setting_text_3': ["Font:",
                                            "",
                                            ""],
               'printtext_setting_text_4': ["Allineamento:",
                                            "",
                                            ""],
...
windows_ = ["GORLU la stampante!", "", ""]

loading_ = ["Caricamento...", "Loading...", "Chargement..."]
